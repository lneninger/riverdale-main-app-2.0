...
namespace RiverdaleMainApp2_0.Controllers
{
    ...
    public class SaleOpportunityTargetPriceProductController : BaseController
    {
        ...
        public IActionResult Post([FromBody]SaleOpportunityTargetPriceProductInsertCommandInputDTO model)
        {
            ...
            {
                var signalArgs = new SignalREventArgs(SignalREvents.DATA_CHANGED.Identifier, nameof(SignalREvents.DATA_CHANGED.ActionEnum.ADDED_ITEM), "SaleOpportunityTargetPriceProduct", appResult.Bag);
