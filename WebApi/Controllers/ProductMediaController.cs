...
namespace RiverdaleMainApp2_0.Controllers
{
    ...
    public class ProductMediaController : BaseController
    {
        ...
        public IActionResult Delete(int id)
        {
            ...
            if (appResult.IsSucceed)
            {
                var signalArgs = new SignalREventArgs(SignalREvents.DATA_CHANGED.Identifier, nameof(SignalREvents.DATA_CHANGED.ActionEnum.DELETED_ITEM), nameof(ProductMedia), appResult.Bag);
                this.SignalRHubContext.Clients.All.DataChanged(signalArgs);
            }
