...
namespace DomainDatabaseMigrations.Migrations
{
    ...
    [Migration("20181207022517_Password rollback")]
    partial class Passwordrollback
    {
            ...
            modelBuilder.Entity("DomainModel.CustomerFreightoutRateType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "CUBE", CreatedAt = new DateTime(2018, 12, 7, 2, 25, 16, 23, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Rate by volume(cubic meters)", Name = "Cube" },
                        new { Id = "BOX", CreatedAt = new DateTime(2018, 12, 7, 2, 25, 16, 24, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Rate by box(amount of containers)", Name = "Box" }
                    );
                });
            ...
            modelBuilder.Entity("DomainModel.ThirdPartyAppType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "BISERP", CreatedAt = new DateTime(2018, 12, 7, 2, 25, 15, 985, DateTimeKind.Utc), CreatedBy = "Seed", Name = "Business ERP" },
                        new { Id = "SFORCE", CreatedAt = new DateTime(2018, 12, 7, 2, 25, 15, 987, DateTimeKind.Utc), CreatedBy = "Seed", Name = "Salesforce" }
                    );
                });
