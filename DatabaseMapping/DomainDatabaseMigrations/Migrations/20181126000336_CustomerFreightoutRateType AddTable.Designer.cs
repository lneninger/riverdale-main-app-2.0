...
namespace DomainDatabaseMigrations.Migrations
{
    ...
    [Migration("20181126000336_CustomerFreightoutRateType AddTable")]
    partial class CustomerFreightoutRateTypeAddTable
    {
            ...
            modelBuilder.Entity("DomainModel.CustomerFreightoutRateType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "CUBE", CreatedAt = new DateTime(2018, 11, 26, 0, 3, 35, 310, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Rate by volume(cubic meters)", Name = "Cube" },
                        new { Id = "BOX", CreatedAt = new DateTime(2018, 11, 26, 0, 3, 35, 310, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Rate by box(amount of containers)", Name = "Box" }
                    );
                });
            ...
            modelBuilder.Entity("DomainModel.ThirdPartyAppType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "BISERP", CreatedAt = new DateTime(2018, 11, 26, 0, 3, 35, 268, DateTimeKind.Utc), CreatedBy = "Seed", Name = "Business ERP" },
                        new { Id = "SFORCE", CreatedAt = new DateTime(2018, 11, 26, 0, 3, 35, 269, DateTimeKind.Utc), CreatedBy = "Seed", Name = "Salesforce" }
                    );
                });
