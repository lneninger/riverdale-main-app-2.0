...
namespace DomainDatabaseMigrations.Migrations
{
    ...
    [Migration("20181126010516_CustomerFreightout AddColumns")]
    partial class CustomerFreightoutAddColumns
    {
            ...
            modelBuilder.Entity("DomainModel.CustomerFreightoutRateType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "CUBE", CreatedAt = new DateTime(2018, 11, 26, 1, 5, 15, 210, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Rate by volume(cubic meters)", Name = "Cube" },
                        new { Id = "BOX", CreatedAt = new DateTime(2018, 11, 26, 1, 5, 15, 210, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Rate by box(amount of containers)", Name = "Box" }
                    );
                });
            ...
            modelBuilder.Entity("DomainModel.ThirdPartyAppType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "BISERP", CreatedAt = new DateTime(2018, 11, 26, 1, 5, 15, 157, DateTimeKind.Utc), CreatedBy = "Seed", Name = "Business ERP" },
                        new { Id = "SFORCE", CreatedAt = new DateTime(2018, 11, 26, 1, 5, 15, 159, DateTimeKind.Utc), CreatedBy = "Seed", Name = "Salesforce" }
                    );
                });
