...
namespace DomainDatabaseMigrations.Migrations
{
    ...
    [Migration("20181202204502_Users Change Password Hash Salt")]
    partial class UsersChangePasswordHashSalt
    {
            ...
            modelBuilder.Entity("DomainModel.CustomerFreightoutRateType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "CUBE", CreatedAt = new DateTime(2018, 12, 2, 20, 45, 1, 395, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Rate by volume(cubic meters)", Name = "Cube" },
                        new { Id = "BOX", CreatedAt = new DateTime(2018, 12, 2, 20, 45, 1, 395, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Rate by box(amount of containers)", Name = "Box" }
                    );
                });
            ...
            modelBuilder.Entity("DomainModel.ThirdPartyAppType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "BISERP", CreatedAt = new DateTime(2018, 12, 2, 20, 45, 1, 345, DateTimeKind.Utc), CreatedBy = "Seed", Name = "Business ERP" },
                        new { Id = "SFORCE", CreatedAt = new DateTime(2018, 12, 2, 20, 45, 1, 348, DateTimeKind.Utc), CreatedBy = "Seed", Name = "Salesforce" }
                    );
                });
