...
namespace DomainDatabaseMigrations.Migrations
{
    ...
    [Migration("20190207020901_Update Schema Funza Quotes Table")]
    partial class UpdateSchemaFunzaQuotesTable
    {
            ...
            modelBuilder.Entity("DomainModel.Company.CompanyType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "GWR", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 383, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Grower/Supplier of Riverdale", Name = "Grower" },
                        new { Id = "CUS", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 384, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Customer of Riverdale", Name = "Customer" }
                    );
                });
            ...
            modelBuilder.Entity("DomainModel.Company.Customer.CustomerFreightoutRateType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "CUBE", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 389, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Rate by volume(cubic meters)", Name = "Cube" },
                        new { Id = "BOX", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 389, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Rate by box(amount of containers)", Name = "Box" }
                    );
                });
            ...
            modelBuilder.Entity("DomainModel.Company.Grower.GrowerType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "THIRD", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 400, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Third Party Grower", Name = "Third Party" },
                        new { Id = "FUNZAMIA", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 400, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Branch Miami", Name = "Funza Miami" },
                        new { Id = "FUNZABTA", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 400, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Branch Bogota", Name = "Funza Bogota" }
                    );
                });
            ...
            modelBuilder.Entity("DomainModel.File.FileSystemType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "SYS", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 421, DateTimeKind.Utc), CreatedBy = "Seed", Description = "File System Repository", Name = "File System" },
                        new { Id = "DB", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 421, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Internal Database Repository", Name = "Database" },
                        new { Id = "AWS", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 421, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Amazon S3 File Repository", Name = "AWS S3" },
                        new { Id = "AZU", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 421, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Azure Storage File Repository", Name = "Azure Storage" }
                    );
                });
            ...
            modelBuilder.Entity("DomainModel.Product.ProductType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "FLW", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 476, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Raw Flower", Name = "Flower" },
                        new { Id = "COMP", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 476, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Multiple Product Composition. Kit", Name = "Composition" },
                        new { Id = "HARD", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 476, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Hardgood", Name = "Hardgood" }
                    );
                });
            ...
            modelBuilder.Entity("DomainModel.SaleOpportunity.SaleSeasonCategoryType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "EVERYDAY", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 447, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Available at any moment", Name = "Every day" },
                        new { Id = "HOLIDAY", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 447, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Holiday", Name = "Holiday" },
                        new { Id = "YEARROUND", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 447, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Sale around the year", Name = "Year round" }
                    );
                });
            ...
            modelBuilder.Entity("DomainModel.ThirdPartyAppType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "BISERP", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 334, DateTimeKind.Utc), CreatedBy = "Seed", Name = "Business ERP" },
                        new { Id = "SFORCE", CreatedAt = new DateTime(2019, 2, 7, 2, 9, 0, 337, DateTimeKind.Utc), CreatedBy = "Seed", Name = "Salesforce" }
                    );
                });
