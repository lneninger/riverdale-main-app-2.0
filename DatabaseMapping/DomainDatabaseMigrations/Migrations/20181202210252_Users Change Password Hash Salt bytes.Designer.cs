...
namespace DomainDatabaseMigrations.Migrations
{
    ...
    [Migration("20181202210252_Users Change Password Hash Salt bytes")]
    partial class UsersChangePasswordHashSaltbytes
    {
            ...
            modelBuilder.Entity("DomainModel.CustomerFreightoutRateType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "CUBE", CreatedAt = new DateTime(2018, 12, 2, 21, 2, 51, 557, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Rate by volume(cubic meters)", Name = "Cube" },
                        new { Id = "BOX", CreatedAt = new DateTime(2018, 12, 2, 21, 2, 51, 557, DateTimeKind.Utc), CreatedBy = "Seed", Description = "Rate by box(amount of containers)", Name = "Box" }
                    );
                });
            ...
            modelBuilder.Entity("DomainModel.ThirdPartyAppType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "BISERP", CreatedAt = new DateTime(2018, 12, 2, 21, 2, 51, 525, DateTimeKind.Utc), CreatedBy = "Seed", Name = "Business ERP" },
                        new { Id = "SFORCE", CreatedAt = new DateTime(2018, 12, 2, 21, 2, 51, 526, DateTimeKind.Utc), CreatedBy = "Seed", Name = "Salesforce" }
                    );
                });
