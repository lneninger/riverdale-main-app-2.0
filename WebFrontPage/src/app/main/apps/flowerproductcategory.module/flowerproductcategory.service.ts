...
@Injectable()
export class FlowerProductCategoryService implements Resolve<any>, IPageQueryService {
    routeParams: any;
    currentEntity: any;
    ...
    getEntity(): Promise<any> {
        return new Promise((resolve, reject) => {
            this.http.get(`${environment.appApi.apiBaseUrl}flowerproductcategory/${this.routeParams.id}`).subscribe(response => {
    ...
    save(entity): Promise<any> {
        return new Promise((resolve, reject) => {
            this.http.put(`${environment.appApi.apiBaseUrl}flowerproductcategory`, entity).subscribe((res: any) => {
                resolve(res);
            },
            error => {
                reject(error);
    ...
    /**
     * Add FlowerProductCategory
     *
     * @param FlowerProductCategory
     * @returns {Promise<any>}
     */
    add(entity): Promise<any> {
        return new Promise((resolve, reject) => {
            this.http.post(`${environment.appApi.apiBaseUrl}flowerproductcategory`, entity).subscribe((res: any) => {
                resolve(res);
            },
            error => {
                reject(error);
