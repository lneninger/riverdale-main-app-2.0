...
@Injectable()
export class GrowerService implements Resolve<any>, IPageQueryService {
    ...
    save(entity): Promise<any> {
        return new Promise((resolve, reject) => {
            this.http.put(`${environment.appApi.apiBaseUrl}grower`, entity).subscribe(
                (res: any) => {
                    resolve(res);
                },
                error => {
    ...
    add(entity): Promise<any> {
        return new Promise((resolve, reject) => {
            this.http.post(`${environment.appApi.apiBaseUrl}grower`, entity).subscribe(
                (res: any) => {
                    resolve(res);
                },
                error => {
    ...
    delete(id: number): any {
        return new Promise((resolve, reject) => {
            this.http.delete(`${environment.appApi.apiBaseUrl}grower/${id}`).subscribe((res: any) => {
                resolve(res);
            },
            error => {
                reject(error);
