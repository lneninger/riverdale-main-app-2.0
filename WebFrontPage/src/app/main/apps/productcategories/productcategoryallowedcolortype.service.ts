...
import { ProductCategoryAllowedColorTypeGrid } from './productcategory.model';

@Injectable()
export class ProductCategoryAllowedColorTypeService implements Resolve<any>, IPageQueryService {
