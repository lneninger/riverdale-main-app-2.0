...
@Injectable()
export class ProductCategoryService implements Resolve<any>, IPageQueryService {
    routeParams: any;
    currentEntity: any;
    ...
    getEntity(): Promise<any> {
        return new Promise((resolve, reject) => {
            this.http.get(`${environment.appApi.apiBaseUrl}productcategory/${this.routeParams.id}`).subscribe(response => {
    ...
    save(entity): Promise<any> {
        return new Promise((resolve, reject) => {
            this.http.put(`${environment.appApi.apiBaseUrl}productcategory`, entity).subscribe((res: any) => {
                resolve(res);
            },
            error => {
                reject(error);
    ...
    add(entity): Promise<any> {
        return new Promise((resolve, reject) => {
            this.http.post(`${environment.appApi.apiBaseUrl}productcategory`, entity).subscribe((res: any) => {
                resolve(res);
            },
            error => {
                reject(error);
