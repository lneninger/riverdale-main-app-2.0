...
@Component({
    selector: 'saleopportunity-view-details',
    templateUrl: './saleopportunity.view-details.component.html',
    styleUrls: ['./saleopportunity.view-details.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : fuseAnimations
})
export class SaleOpportunityViewDetailsComponent implements OnInit, OnDestroy
{
    todo: Todo;
    tags: any[];
    formType: string;
