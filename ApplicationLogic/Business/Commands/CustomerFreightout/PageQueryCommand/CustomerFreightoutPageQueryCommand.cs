...
{
    public class CustomerFreightoutPageQueryCommand : AbstractDBCommand<DomainModel.Company.Customer.CustomerFreightout, ICustomerFreightoutDBRepository>, ICustomerFreightoutPageQueryCommand
    {
