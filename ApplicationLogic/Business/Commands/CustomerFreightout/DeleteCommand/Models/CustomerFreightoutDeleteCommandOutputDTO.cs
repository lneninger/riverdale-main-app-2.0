...
namespace ApplicationLogic.Business.Commands.CustomerFreightout.DeleteCommand.Models
{
    public class CustomerFreightoutDeleteCommandOutputDTO
    {

        public CustomerFreightoutDeleteCommandOutputDTO()
        {
        }
