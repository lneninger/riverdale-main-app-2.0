...
" + Environment.StackTrace;
        ...
        private static readonly AsyncLocal<InstanceIdentifier> InstanceIdentifierStatic = new AsyncLocal<InstanceIdentifier>();
        ...
        internal static void SetAmbientScope(DbContextScope newAmbientScope) {
            ...
            var current = InstanceIdentifierStatic.Value;
            ...
            InstanceIdentifierStatic.Value = newAmbientScope._instanceIdentifier;
        ...
        internal static void RemoveAmbientScope() {
            var current = InstanceIdentifierStatic.Value;// CallContext.LogicalGetData(AmbientDbContextScopeKey) as InstanceIdentifier;
            InstanceIdentifierStatic.Value = null;
        ...
        internal static void HideAmbientScope() {
            InstanceIdentifierStatic.Value = null;// CallContext.LogicalGetData(AmbientDbContextScopeKey) as InstanceIdentifier;
        ...
        internal static DbContextScope GetAmbientScope() {
            ...
            var instanceIdentifier = InstanceIdentifierStatic.Value;// CallContext.LogicalGetData(AmbientDbContextScopeKey) as InstanceIdentifier;
